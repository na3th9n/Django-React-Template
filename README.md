...
This project is a full-stack application that includes user authentication by utilizing JWT tokens. This application lets users create notes and stores these in a database. The backend is maintained with Python and Django, and the frontend is React.
